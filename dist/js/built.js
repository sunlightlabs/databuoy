...
var App = React.createClass({
  ...
  render: function render() {
    return React.createElement(DataContainer, { route: this.state.route });
  }
});
    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            'td',
            { className: "temporal conditional" },
            React.createElement(
              'span',
              { className: "label" },
              'temporal'
          ...
          React.createElement(
            'td',
            { className: "accrualPeriodicity optional" },
            React.createElement(
              'span',
              { className: "label" },
              'accrualPeriodicity'
          ...
          React.createElement(
            'td',
            { className: "describedBy optional" },
            React.createElement(
              'span',
              { className: "label" },
              'describedBy'
          ...
          React.createElement(
            'td',
            { className: "describedByType optional" },
            React.createElement(
              'span',
              { className: "label" },
              'describedByType'
          ...
          React.createElement(
            'td',
            { className: "landingPage optional" },
            React.createElement(
              'span',
              { className: "label" },
              'landingPage'
          ...
          React.createElement(
            'td',
            { className: "contactPoint_fn" },
            'contactPoint: full name'
          ),
          React.createElement(
            'td',
            { className: "contactPoint_hasEmail" },
  ...
  render: function render() {
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          'a',
          { href: Data.makeDatasetLink(this.props.data) },
      ...
      React.createElement(
        'td',
        { className: "description hidden" },
        Utils.parseDescription(this.props.data.description)
      ),
      React.createElement(
        'td',
        { className: "keyword" },
        Utils.parseKeywords(this.props.data.keyword)
      ),
      React.createElement(
        'td',
        { className: "modified" },
        this.props.data.modified
      ),
      React.createElement(
        'td',
        { className: "publisher" },
      ...
      React.createElement(
        'td',
        { className: "rights conditional" },
        this.props.data.rights
      ),
      React.createElement(
        'td',
        { className: "temporal conditional" },
        this.props.data.temporal
      ),
      React.createElement(
        'td',
        { className: "spatial conditional" },
        this.props.data.spatial
      ),
      React.createElement(
        'td',
        { className: "accrualPeriodicity optional" },
        this.props.data.accrualPeriodicity
      ),
      React.createElement(
        'td',
        { className: "conformsTo optional" },
        this.props.data.conformsTo
      ),
      React.createElement(
        'td',
        { className: "describedBy optional" },
        this.props.data.describedBy
      ),
      React.createElement(
        'td',
        { className: "describedByType optional" },
        this.props.data.describedByType
      ),
      React.createElement(
        'td',
        { className: "isPartOf optional" },
        this.props.data.isPartOf
      ),
      React.createElement(
        'td',
        { className: "issued optional" },
      ...
      React.createElement(
        'td',
        { className: "contactPoint_fn" },
        this.props.data.contactPoint.fn
      ),
      React.createElement(
        'td',
        { className: "contactPoint_hasEmail" },
        Utils.parseEmail(this.props.data.contactPoint.hasEmail)
      )
    );
  }
});
  ...
  render: function render() {
    return React.createElement(
      ...
      React.createElement(
        ...
        this.props.contactPoint && this.props.contactPoint.fn
      ),
      React.createElement(
        'div',
        null,
...
var Data = {
  ...
  cleanDatasets: function cleanDatasets(objects) {
    ...
    for (i = 0; i < objects.length; i++) {
      if (objects[i].issued !== "Date of formal issuance.") {
        //We have an explainer row that we need to ignore
        object = objects[i];
  ...
  getDataset: function getDataset(buoy_id, dataset_array) {
  ...
  convertCSVtoJSON: function convertCSVtoJSON(csv) {
    ...
    if (parsed_csv.errors.length === 0) {
      ...
      for (i = 0; i < parsed_csv.data.length; i++) {
        if (parsed_csv.data[i].title === "") {
          // in this case, we will assume the row is a distribution of the last title-having row
  ...
  convertCSVAttrToJSON: function convertCSVAttrToJSON(key, current_row_obj, cache_row) {
  ...
  convertPublisher: function convertPublisher(key, current_row_obj, cache_row) {
    return {
      "@type": "org:Organization",
      "name": current_row_obj.publisher
    };
  },
  convertContactPoint: function convertContactPoint(key, current_row_obj, cache_row) {
    return {
      "@type": "vcard:Contact",
  ...
  convertDistribution: function convertDistribution(key, current_row_obj, cache_row) {
    distribution = {};
  ...
  convertCSVStringToArray: function convertCSVStringToArray(key, current_row_obj, cache_row) {
    return Utils.parseStringToArray(current_row_obj[key]);
  },
  convertKeyGroupToJson: function convertKeyGroupToJson(key_group, current_row_obj, cache_row) {
    key_group_obj = {};
    for (var k in current_row_obj) {
  ...
  isDistributionColumn: function isDistributionColumn(key) {
    return key.match('distribution') !== null;
  },
  keyGroupHasNotBeenProcessed: function keyGroupHasNotBeenProcessed(key, current_row_obj) {
    return current_row_obj[key] === undefined;
  },
  keyGroup: function keyGroup(key) {
    key = key.split(":");
    if (key.length > 1) {
      return key[0];
    } else {
...
var Routes = {
  parse_search: function parse_search() {
  ...
  parse_dataset_id: function parse_dataset_id(search) {
